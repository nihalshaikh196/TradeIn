...
where(user_list.adder_id='$distributor_id' OR orders.user_id='$distributor_id' ) AND orders.order_status='Confirmed' AND product.product_id=orders.product_id GROUP BY orders.product_id";
